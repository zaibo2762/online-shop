                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number"  name="max_uses" id="max_uses" class="form-control" placeholder="Maximum Uses">	
                            <p></p>
                        </div>	
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text"  name="max_uses_users" id="max_uses_users" class="form-control" placeholder="Maximum Uses Users">	
                            <p></p>
                        </div>	
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text"  name="starts_at" id="starts_at" class="form-control" placeholder="start date">	
                            <p></p>
                        </div>	
                    </div>									
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text"  name="expires_at" id="expires_at" class="form-control" placeholder="expires date">	
                            <p></p>
                        </div>	
                    </div>	
                    <div class="col-md-6">
