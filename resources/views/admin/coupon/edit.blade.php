                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $coupon->max_uses }}"  name="max_uses" id="max_uses" class="form-control" placeholder="Maximum Uses">	
                            <p></p>
                        </div>	
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $coupon->max_uses_user }}"  name="max_uses_users" id="max_uses_users" class="form-control" placeholder="Maximum Uses Users">	
                            <p></p>
                        </div>	
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $coupon->discount_amount }}"  name="discount_amount" id="discount_amount" class="form-control" placeholder="Discount Amount">	
                            <p></p>
                        </div>	
                    </div>								
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $coupon->min_amount }}"  name="min_amount" id="min_amount" class="form-control" placeholder="Minimum Amount">	
                            <p></p>
                        </div>	
                    </div>								
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input autocomplete="off" value="{{ $coupon->starts_at }}" type="text"  name="starts_at" id="starts_at" class="form-control" placeholder="start date">	
                            <p></p>
                        </div>	
                    </div>									
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input autocomplete="off" value="{{ $coupon->expires_at }}" type="text"  name="expires_at" id="expires_at" class="form-control" placeholder="expires date">	
                            <p></p>
                        </div>	
                    </div>	
                    <div class="col-md-6">
