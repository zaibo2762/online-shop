                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" readonly value="{{ $product->slug }}" name="slug"
                                ...
                                @foreach ($productImages as $image)
                                    <div class="col-md-3" id='image-row-{{ $image->id }}'>
                                        <div class="card" style="width: 18rem;">
                                            ...
                                            <img src="{{ asset('temp/' . $image->image) }}" height= "300px", width= "275px"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="compare_price"
                                                value="{{ $product->compare_price }}" id="compare_price"
