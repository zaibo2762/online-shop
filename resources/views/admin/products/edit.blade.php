            ...
            <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" readonly value="{{ $product->slug }}" name="slug" id="slug" class="form-control" placeholder="slug">	
                                    <p class='error'></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                ...
                <div class="row" id="product-gallery">
                    ...
                    <div class="col-md-3" id='image-row-{{ $image->id }}'>
                        ...
                        <img src="{{ asset('temp/'.$image->image) }}" height= "300px", width= "275px" class="card-img-top" alt="...">
                        <div class="card-body">
