                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input value="{{ $user->phone }}" type="text"  name="phone" id="phone" class="form-control" placeholder="Phone no">	
                            <p></p>
                        </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.status === true) {
                ...
                $('#name, #email, #phone').removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html('');
            } else {
