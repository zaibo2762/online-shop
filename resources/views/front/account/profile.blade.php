                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input value="{{ !empty($address) ? $address->appartment : '' }}"
                                            type="text" name="appartment" id="appartment"
                                            placeholder="Enter Your Appartment" class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input value="{{ !empty($address) ? $address->zip : '' }}" type="text"
                                            name="zip" id="zip" placeholder="Enter Your Zip Code"
                                            class="form-control">
                                        <p></p>
                                    </div>
                                </div>
                    ...
                    if (response.status == true) {
                        ...
                        if (errors.appartment) {
                            $("#appartment").addClass('is-invalid').siblings('p').html(errors
                                .appartment).addClass('invalid-feedback');
                        } else {
