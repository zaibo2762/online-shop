                            ...
                            @if ($product->product_image)
                                @foreach ($product->product_image as $key => $productImage)
                                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                        <img class="w-100 h-100" src="{{ asset('temp/' . $productImage->image) }}"
                                            alt="Image">
                                    </div>
                                @endforeach
                            @endif
                    ...
                    <div class="bg-light">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                <div class="col-md-8">
                                    <div class="row">
                                        <form action="" method="POSTcomment" name="productRatingForm"
                                        ...
                                        @foreach ($product->product_ratings as $rating)
                                            <div class="rating-group mb-4">
                                                ...
                                                <div class="star-rating mt-2">
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        <i class="fa fa-star{{ $i <= $rating->rating ? ' text-warning' : ' text-secondary' }}"
                                                            aria-hidden="true"></i>
                                                    @endfor
                                                </div>
                                                <div class="my-3">
                                    ...
                                    <a href="" class="product-img">
                                        @if (!empty($productImage->image))
                                            <img class="card-img-top"
                                                src="{{ asset('temp/' . $relatedProductImage->image) }}" width="50">
                                        @else
